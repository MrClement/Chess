...
public class DerpyAITester extends DerpyAI {
	...
	public static void main(String[] args) {
		...
		System.out.print("Test 3: "); if(tester.pieceCanMoveToPosition(b.getBoardArray()[3][1], new Point(3,2))){System.out.println("Passed");} else {System.out.println("FAILED!  <<<");}
		System.out.print("Test 4: "); if(tester.pieceCanMoveToPosition(b.getBoardArray()[4][1], new Point(4,2))){System.out.println("Passed");} else {System.out.println("FAILED!  <<<");}
		System.out.print("Test 5: "); if(tester.pieceCanMoveToPosition(b.getBoardArray()[5][1], new Point(5,2))){System.out.println("Passed");} else {System.out.println("FAILED!  <<<");}
		System.out.print("Test 6: "); if(tester.pieceCanMoveToPosition(b.getBoardArray()[6][1], new Point(6,2))){System.out.println("Passed");} else {System.out.println("FAILED!  <<<");}
		System.out.print("Test 7: "); if(tester.pieceCanMoveToPosition(b.getBoardArray()[7][1], new Point(7,2))){System.out.println("Passed");} else {System.out.println("FAILED!  <<<");}
		
		System.out.print("Test 8: "); if(tester.pieceCanMoveToPosition(b.getBoardArray()[0][1], new Point(0,3))){System.out.println("Passed");} else {System.out.println("FAILED!  <<<");}
		System.out.print("Test 9: "); if(tester.pieceCanMoveToPosition(b.getBoardArray()[1][1], new Point(1,3))){System.out.println("Passed");} else {System.out.println("FAILED!  <<<");}
		System.out.print("Test 10: "); if(tester.pieceCanMoveToPosition(b.getBoardArray()[2][1], new Point(2,3))){System.out.println("Passed");} else {System.out.println("FAILED!  <<<");}
		System.out.print("Test 11: "); if(tester.pieceCanMoveToPosition(b.getBoardArray()[3][1], new Point(3,3))){System.out.println("Passed");} else {System.out.println("FAILED!  <<<");}
		System.out.print("Test 12: "); if(tester.pieceCanMoveToPosition(b.getBoardArray()[4][1], new Point(4,3))){System.out.println("Passed");} else {System.out.println("FAILED!  <<<");}
		System.out.print("Test 13: "); if(tester.pieceCanMoveToPosition(b.getBoardArray()[5][1], new Point(5,3))){System.out.println("Passed");} else {System.out.println("FAILED!  <<<");}
		System.out.print("Test 14: "); if(tester.pieceCanMoveToPosition(b.getBoardArray()[6][1], new Point(6,3))){System.out.println("Passed");} else {System.out.println("FAILED!  <<<");}
